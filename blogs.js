...
async function takeBlogView(){
  ...
  await axios.get(`https://sparkling-petticoat-bull.cyclic.app/api/v1/blogs/${blogID}`).then((res)=>{
    console.log(res)
  ...
  let blogDisplay = document.getElementById('blog-display')
      ...
      <div style='display:flex;'>
       <i><img src="/imge&icon/heart like.png" alt="" onclick ="like()" class = "like-t"></i>
...
function comment(){
  ...
  async function displayComment(){
    ...
    await axios.get(`https://sparkling-petticoat-bull.cyclic.app/api/v1/blogs/${blogID}/comments`).then((res)=>{
